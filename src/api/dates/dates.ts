import { GetUpcomingDatesResponse, LockOrderingAndPaymentsRequest } from "./schema";
...
export async function lockOrderingAndPayments(req: LockOrderingAndPaymentsRequest) {
  // Fake data for development
  // await(t => new Promise(r => setTimeout(r, t)))(500);
  // return {
  //   dates: [new Date("2023-08-29"), new Date("2023-08-31"), new Date("2023-09-1"), new Date("2023-09-2"), new Date("2023-09-4")]
  // }
  return sendRequest<GetUpcomingDatesResponse>("/api/admin/order/lock", HttpMethods.PATCH, true, undefined, req);
}
